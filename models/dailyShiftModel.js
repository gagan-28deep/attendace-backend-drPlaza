...
const schemaName = "daliyShift";

const dailySchema = mongoose.Schema({
  user: { type: [mongoose.Schema.ObjectId], ref: "shiftSchema" }, // Reference of User
  shift: { type: [mongoose.Schema.ObjectId], ref: "shiftSchema" }, // Reference of User
...
const dailyModel = mongoose.model(schemaName, dailySchema, schemaName);
